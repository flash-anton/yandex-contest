 ...
 * <a href="https://contest.yandex.ru/contest/27472/run-report/93122337">OK  210ms  13.13Mb</a>
 *
 ...
 * начиная со второй, записано — ближе или дальше она к звуку треугольника, чем предыдущая нота. Заранее известно,
...
public class J {
    ...
    public static void alg(BufferedReader reader, BufferedWriter writer) throws IOException {
        ...
        for (int i = 0; i < n - 1; i++) {
            ...
            double next = Double.parseDouble(buf[0]);
            boolean isFurther = buf[1].equals("further");

            double mid = (next + prev) / 2;

            if ((next > prev && isFurther) || (next < prev && !isFurther)) {
        ...
        writer.write(String.format("%s %s", min, max));
        writer.flush();
    }
}
