 ...
 * <a href="https://contest.yandex.ru/contest/28069/run-report/106252916">OK  364ms  35.61Mb</a>
 *
 * E. Вывод листьев
...
public class E {
    ...
    static class Node {
        ...
        List<Long> leaves() {
            ...
            if (smaller != null)
                leaves.addAll(smaller.leaves());

            if (greater != null)
                leaves.addAll(greater.leaves());

            if (value != null && leaves.isEmpty())
                leaves.add(value);
